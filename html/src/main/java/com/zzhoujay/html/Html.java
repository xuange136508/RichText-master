...
public class Html {
    ...
    public static Spanned fromHtml(String source) {
        return fromHtml(source, FROM_HTML_MODE_LEGACY, null, null, false);
    }
    ...
    public static Spanned fromHtml(String source, int flags) {
        return fromHtml(source, flags, null, null, false);
    }
    ...
    public static Spanned fromHtml(String source, android.text.Html.ImageGetter imageGetter, android.text.Html.TagHandler tagHandler) {
        return fromHtml(source, FROM_HTML_MODE_LEGACY, imageGetter, tagHandler, false);
    }

    public static Spanned fromHtml(String source, android.text.Html.ImageGetter imageGetter, android.text.Html.TagHandler tagHandler, boolean isSpec) {
        return fromHtml(source, FROM_HTML_MODE_LEGACY, imageGetter, tagHandler, isSpec);
    }
    ...
    public static Spanned fromHtml(String source, int flags, android.text.Html.ImageGetter imageGetter,
                                   android.text.Html.TagHandler tagHandler, boolean isSpec) {
        ...
        if(isSpec){
            MamaHtmlToSpannedConverter converter = new MamaHtmlToSpannedConverter(source, imageGetter, tagHandler, parser, flags);
