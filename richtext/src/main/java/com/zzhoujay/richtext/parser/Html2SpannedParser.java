...
public class Html2SpannedParser implements SpannedParser {
    ...
    static {
        ...
        try {
            fromHtml = Class.forName(Z_HTML_CLASS_NAME).getMethod("fromHtml", String.class, Html.ImageGetter.class, Html.TagHandler.class, boolean.class);
    ...
    public Html2SpannedParser(Html.TagHandler tagHandler, boolean isSpec) {
    ...
    public Spanned parse(String source) {
        if (Z_FROM_HTML_METHOD != null) {
            try {
                return (Spanned) Z_FROM_HTML_METHOD.invoke(null, source, null, tagHandler, isSpec);
            } catch (Exception e) {
