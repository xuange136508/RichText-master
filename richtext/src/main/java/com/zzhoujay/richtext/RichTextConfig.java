...
public final class RichTextConfig {
    ...
    private RichTextConfig(RichTextConfigBuild config) {
        this(config.source, config.richType, config.autoFix, config.resetSize, config.cacheType, config.imageFixCallback,
                ...
                config.errorImageDrawableGetter, config.isSpec);
    }
    ...
    private RichTextConfig(String source, RichType richType, boolean autoFix, boolean resetSize, CacheType cacheType,
                           ...
                           ImageDownloader imageDownloader, DrawableGetter placeHolderDrawableGetter, DrawableGetter errorImageDrawableGetter, boolean isSpec) {
        this.source = source;
    ...
    public static final class RichTextConfigBuild {
        ...
        RichTextConfigBuild(String source, RichType richType, boolean isSpec) {
            this.source = source;
            this.richType = richType;
            this.autoFix = true;
        ...
        public RichTextConfigBuild isSpec(boolean isSpec) {
            this.isSpec = isSpec;
            return this;
        }
